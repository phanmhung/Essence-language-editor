...
class NewMethod extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      author: '',
      createdMethod: false,
      alphaState: this.props.essence_kernel.detail.state
        ? this.props.essence_kernel.detail.state
        : [],
      level_of_detail: this.props.essence_kernel.detail.level_of_detail
        ? this.props.essence_kernel.detail.level_of_detail
        : [],
    };
  ...
  saveAlpha() {
    ...
    if (this.state.alpha_name) {
      this.props.graph_global.cellLabelChanged(
        this.props.essence_kernel,
        this.state.alpha_name
      );

      if (
        this.state.alpha_name === 'Work' ||
        ...
        this.props.essence_kernel.detail.subAlpha.map(
          (subAlpha, key) =>
            (this.props.essence_kernels.filter(function (data) {
        ...
        this.props.essence_kernel.detail.workProduct.map(
          (workProduct, key) =>
            (this.props.essence_kernels.filter(function (data) {
        ...
        this.state.alpha_name === 'Opportunity' ||
        ...
        this.state.alpha_name === 'Requirements' ||
  ...
  saveActivitySpace() {
    ...
    if (this.state.activity_space_name) {
      ...
      if (
        ...
        this.props.essence_kernel.detail.activity.map(
          (activity, key) =>
            (this.props.essence_kernels.filter(function (data) {
        ...
        this.state.activity_space_name === 'Understand The Requirements' ||
        ...
        this.state.activity_space_name === 'Coordinate Activity' ||
  ...
  saveCompetency() {
    ...
    competency_detail.description = this.state.competency_description
      ? this.state.competency_description
      : '';
      ...
      if (data.detail.type === 'Alpha') {
          ...
          return (
            <div className={classes.paper}>
              ...
              {alphaState.map((alphaStateData, index) => (
                <State
                  state={alphaStateData}
                  key={index}
                  index={index}
                  saveStateAlpha={this.saveStateAlpha}
                ></State>
              ))}
              <br />
              <Button
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={this.saveAlpha.bind(this)}
              >
                Save
              </Button>
            </div>
        ...
        return (
          <div className={classes.paper}>
            ...
            <br />
            <input
              defaultChecked={data.detail.level.Assists}
              type="checkbox"
            ...
            Assists
            <input
              defaultChecked={data.detail.level.Applies}
              type="checkbox"
              onClick={this.updateState.bind(this)}
              name="Applies"
              value="Applies"
            ...
            Applies
            <input
              defaultChecked={data.detail.level.Masters}
              type="checkbox"
              onClick={this.updateState.bind(this)}
              name="Masters"
              value="Masters"
            ...
            Masters
            <input
              defaultChecked={data.detail.level.Adapt}
              type="checkbox"
              onClick={this.updateState.bind(this)}
              name="Adapt"
              value="Adapt"
            ...
            Adapt
            <input
              defaultChecked={data.detail.level.Innovates}
              type="checkbox"
              onClick={this.updateState.bind(this)}
              name="Innovates"
              value="Innovates"
            ...
            <Button
              variant="contained"
              color="primary"
              onClick={this.saveCompetency.bind(this)}
            >
              Save Data
            </Button>
          </div>
        ...
        return (
          <div className={classes.paper}>
            ...
            >
              ...
              <MenuItem value={'Explore Possibillities'}>
                Explore Possibillities
              </MenuItem>
              <MenuItem value={'Understand Stakeholder Needs'}>
                Understand Stakeholder Needs
              </MenuItem>
              <MenuItem value={'Ensure Stakeholder Satisfaction'}>
                Ensure Stakeholder Satisfaction
              </MenuItem>
              <MenuItem value={'Use The System'}>Use The System</MenuItem>
              <MenuItem value={'Understand The Requirements'}>
                Understand The Requirements
              </MenuItem>
              <MenuItem value={'Shape The System'}>Shape The System</MenuItem>
              <MenuItem value={'Implement The System'}>
                Implement The System
              </MenuItem>
              <MenuItem value={'Test The System'}>Test The System</MenuItem>
              <MenuItem value={'Deploy The System'}>Deploy The System</MenuItem>
              <MenuItem value={'Operate The System'}>
                Operate The System
              </MenuItem>
              <MenuItem value={'Prepare To Do The Work'}>
                Prepare To Do The Work
              </MenuItem>
              <MenuItem value={'Coordinate Activity'}>
                Coordinate Activity
              </MenuItem>
            ...
            <Button
              variant="contained"
              color="primary"
              onClick={this.saveActivitySpace.bind(this)}
            >
              Save Data
            </Button>
          </div>
        ...
        return (
          <div className={classes.paper}>
            Edit Work Product Detail
            <br />
            <br />
            <TextField
              id="work_product_name"
              fullWidth
            ...
            <Button
              ...
              color="primary"
              onClick={() =>
                this.setState({ level_of_detail: [...level_of_detail, ''] })
              }
            >
              Add level detail
            </Button>
            ...
            <Button
              variant="contained"
              color="primary"
              onClick={this.saveWorkProduct.bind(this)}
            >
              Save Data
            </Button>
          </div>
